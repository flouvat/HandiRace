...
var Player1 = {
    ...
    renderedColor: app.options.athlete1couleur,      // color of the rendered car for Player1 (default is RED)
    renderingStraight: null,
    renderingLeft: null,
    renderingRight: null,
    malus: app.options.athlete1difficulte,           // multiply the distance Player1 has to travel to reach the finish line
...
var Player2 = {
    ...
    renderedColor: app.options.athlete2couleur,     // color of the rendered car for Player2 (default is RED)
    renderingStraight: null,
    renderingLeft: null,
    renderingRight: null,
    malus: app.options.athlete2difficulte,           // multiply the distance Player2 has to travel to reach the finish line
...
function render() {
    ...
    if(!roadStyle){                                                                                             // different scale for the wheelchairs
        // rendering Player1 on own screen
        Render.player(context1, width, resolution, roadWidth, sprites, Player1.renderingStraight,
                        Player1.speed/maxSpeed, 1.5*cameraDepth/Player1.Z, width/2, height);

        // rendering Player2 on Player1's screen
        ...
        Render.player(context2, width, resolution, roadWidth, sprites, Player2.renderingStraight,
                        Player2.speed/maxSpeed, 1.5*cameraDepth/Player2.Z, width/2, height);

        // rendering Player1 on Player2's screen            
...
function loadColor(){
    ...
    switch(Player1.renderedColor){
        ...
        case 'ORANGE':
            ...
            break;
        case 'CHAIR':
            Player1.renderingStraight = SPRITES.PLAYER_STRAIGHT.CHAIR;
            Player1.renderingLeft = SPRITES.PLAYER_LEFT.CHAIR;
            Player1.renderingRight = SPRITES.PLAYER_RIGHT.CHAIR;
            break;
        default:
            Player1.renderingStraight = SPRITES.PLAYER_STRAIGHT.RED;
            Player1.renderingLeft = SPRITES.PLAYER_LEFT.RED;
    ...
    switch(Player2.renderedColor){
        ...
        case 'ORANGE':
            ...
            break;
        case 'CHAIR':
            Player2.renderingStraight = SPRITES.PLAYER_STRAIGHT.CHAIR;
            Player2.renderingLeft = SPRITES.PLAYER_LEFT.CHAIR;
            Player2.renderingRight = SPRITES.PLAYER_RIGHT.CHAIR;
            break;
        default:
            Player2.renderingStraight = SPRITES.PLAYER_STRAIGHT.RED;
            Player2.renderingLeft = SPRITES.PLAYER_LEFT.RED;
