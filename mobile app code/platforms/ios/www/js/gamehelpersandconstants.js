...
var Game = {  // a modified version of the game loop from my previous boulderdash game - see http://codeincomplete.com/posts/2011/10/25/javascript_boulderdash/#gameloop
  ...
  run: function(options) {
    ...
    Game.loadImages(options.images, function(images) {
      ...
      options.colorPicker(); // initialize cars with their respective colors

      Game.setKeyListener(options.keys);

      var canvas = options.canvas,        // canvas render target is provided by caller
          update = options.update,        // method to update game logic is provided by caller
          updatehud = options.updatehud,  // method to update the hud is provided by caller
      ...
      //*/                                    USING REQUEST ANIMATION FRAME (RECURSIVE)
      function frame() {
        now = Util.timestamp();
      ...
      /*/                                      USING SET INTERVAL (NON RECURSIVE)
...
var SPRITES = {
  ...
  PLAYER_LEFT: {
    RED:    { x:  620, y: 1065, w: 80, h: 41},
    BLUE:   { x:  620, y: 1116, w: 80, h: 41},
    GREEN:  { x:  620, y: 1167, w: 80, h: 41},
    YELLOW: { x:  620, y: 1218, w: 80, h: 41},
    PINK:   { x:  620, y: 1269, w: 80, h: 41},
    CYAN:   { x:  620, y: 1320, w: 80, h: 41},
    ORANGE: { x:  620, y: 1371, w: 80, h: 41}
  },

  PLAYER_STRAIGHT: {
    RED:    { x:  711, y: 1065, w: 80, h: 41},
    BLUE:   { x:  711, y: 1116, w: 80, h: 41},
    GREEN:  { x:  711, y: 1167, w: 80, h: 41},
    YELLOW: { x:  711, y: 1218, w: 80, h: 41},
    PINK:   { x:  711, y: 1269, w: 80, h: 41},
    CYAN:   { x:  711, y: 1320, w: 80, h: 41},
    ORANGE: { x:  711, y: 1371, w: 80, h: 41}
  },

  PLAYER_RIGHT: {
    RED:    { x:  802, y: 1065, w: 80, h: 41},
    BLUE:   { x:  802, y: 1116, w: 80, h: 41},
    GREEN:  { x:  802, y: 1167, w: 80, h: 41},
    YELLOW: { x:  802, y: 1218, w: 80, h: 41},
    PINK:   { x:  802, y: 1269, w: 80, h: 41},
    CYAN:   { x:  802, y: 1320, w: 80, h: 41},
    ORANGE: { x:  802, y: 1371, w: 80, h: 41}
  }
};
