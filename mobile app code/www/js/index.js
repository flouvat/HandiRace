...
var app = {
    ...
    options: {  // all variables used in both data and game and set by the user in optionsScreen
        ...
        athlete1nom: document.getElementById('player1Name').value,
        athlete2nom: document.getElementById('player2Name').value,
        athlete1couleur: document.getElementById('couleurAthlete1').value,
        athlete2couleur: document.getElementById('couleurAthlete2').value,
        athlete1difficulte: document.getElementById('coefDif1').value,
        athlete2difficulte: document.getElementById('coefDif2').value
    },
    ...
    saveOptions: function(){
        ...
        if(app.options.styleTerrain != "track"){
            app.options.athlete1couleur = document.getElementById('couleurAthlete1').value;
            app.options.athlete2couleur = document.getElementById('couleurAthlete2').value;
        }
        else{
            app.options.athlete1couleur = "CHAIR";
            app.options.athlete2couleur = "CHAIR";
        }
        app.options.athlete1nom = document.getElementById('player1Name').value;
        app.options.athlete2nom = document.getElementById('player2Name').value;
        if( parseInt(app.options.athlete1difficulte = document.getElementById('coefDif1').value) < 1) app.options.athlete1difficulte = 1;
        if( parseInt(app.options.athlete2difficulte = document.getElementById('coefDif2').value) < 1) app.options.athlete2difficulte = 1;
    ...
    cancelOptions: function(){
        ...
        document.getElementById('player1Name').value = app.options.athlete1nom;
        if( (document.getElementById('racer1Name').innerHTML = app.options.athlete1nom) == "" ) document.getElementById('racer1Name').innerHTML = "Athlete 1";
        document.getElementById('player2Name').value = app.options.athlete2nom;
        if( (document.getElementById('racer2Name').innerHTML = app.options.athlete2nom) == "" ) document.getElementById('racer2Name').innerHTML = "Athlete 2";
        document.getElementById('couleurAthlete1').value = app.options.athlete1couleur;
        document.getElementById('couleurAthlete2').value = app.options.athlete2couleur;
        document.getElementById('coefDif1').value = app.options.athlete1difficulte;
        document.getElementById('coefDif2').value = app.options.athlete2difficulte;
        document.getElementById('coefDif1Label').innerHTML = "x"+app.options.athlete1difficulte;
        document.getElementById('coefDif2Label').innerHTML = "x"+app.options.athlete2difficulte;
        app.quitOptions();
    },
